create type "public"."Tag Categories" as enum ('Pokédex', 'Sprites', 'New', 'Altered', 'Quality of Life', 'Gameplay', 'Difficulty', 'Scale', 'Tone');

alter table "public"."tags" add column "category" "Tag Categories";
